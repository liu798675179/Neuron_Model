...
public:
    ...
    Neuron_Normal(double const &temp_v, double const &temp_I_Na, double const &temp_I_K, double const &temp_n) : V(temp_v), I_Na(temp_I_Na), I_K(temp_I_K), n(temp_n) { }
...
Neuron_Normal Neuron_Normal::HH_Model(Neuron_Normal &temp_Neu) const {
    ...
    return Neuron_Normal(temp_Neu.V, temp_Neu.I_Na, temp_Neu.I_K, temp_Neu.n);
}
...
public:
    ...
    Neuron_AD(double const &temp_v, double const &temp_I_Na, double const &temp_I_K, double const &temp_n) : V(temp_v), I_Na(temp_I_Na), I_K(temp_I_K), n(temp_n) { }
...
Neuron_AD Neuron_AD::HH_Model(Neuron_AD &temp_Neu) const {
    ...
    return Neuron_AD(temp_Neu.V, temp_Neu.I_Na, temp_Neu.I_K, temp_Neu.n);
}
