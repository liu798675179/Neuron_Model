...
//The membrane capacitance. Demention : μF/cm^2
double const C = 1;
...
public:
	...
	pair<vector<double>, vector<double>> Simulation() const;
...
Neuron_AD Neuron_AD::HH_Model(Neuron_AD &temp_Neu) const {
	...
	return Neuron_AD(temp_Neu.V, temp_Neu.h, temp_Neu.n);
}
...
inline
pair<vector<double>, vector<double>> Neuron_AD::Simulation() const {
...
Neuron_Normal Neuron_Normal::HH_Model(Neuron_Normal &temp_Neu) const {
	...
	return Neuron_Normal(temp_Neu.V, temp_Neu.h, temp_Neu.n);
}
...
inline
pair<vector<double>, vector<double>> Neuron_Normal::Simulation() const {
